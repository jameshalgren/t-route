                ...
                for cluster, clustered_subns in reaches_ordered_bysubntw_clustered[
                    ...
                    jobs.append(
                        delayed(compute_func)(
                            ...
                            param_df_sub.values,
                            q0_sub.values.astype("float64"),
                            qlat_sub.values.astype("float64"),
                            lake_segs, 
                            ...
                            waterbody_type_specified,
                            model_start_time,
                            usgs_df_sub.values.astype("float64"),
                ...
                for twi, (subn_tw, subn_reach_list) in enumerate(
                    ...
                    jobs.append(
                        delayed(compute_func_switch)(
                            ...
                            np.array(da_positions_list_byreach, dtype="int32"),
                            np.array(da_positions_list_bygage, dtype="int32"),
                            lastobs_df_sub.get("last_obs_discharge", pd.Series(index=lastobs_df_sub.index, name="Null")).values.astype("float64"),
                            lastobs_df_sub.get("time_since_lastobs", pd.Series(index=lastobs_df_sub.index, name="Null")).values.astype("float64"),
                            da_decay_coefficient,
                            # flowveldepth_interorder,  # obtain keys and values from this dataset
                            {
                                us: fvd
